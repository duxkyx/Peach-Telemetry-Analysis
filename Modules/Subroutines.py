...
# This program file will store commonly used subroutines to save space within other program files.
...
# This subroutine takes an array which has more than one array contained inside (as a child) - 3D Array
...
def heading_Print(text):
    divider_string = ''
    main_string = ''
    length = 25
    divider_Length = 50
    text_Length = len(text)
    for i in range(0,int((length-text_Length) + text_Length / 2)):
        main_string += ' '
    
    main_string += text

    for i in range(0,int((length-text_Length))):
        main_string += ' '

    for i in range(0,divider_Length):
        divider_string += '-'

    print(' ')
    print(f'{divider_string}')
    print(main_string)
    print(f'{divider_string}')
    print(' ')
